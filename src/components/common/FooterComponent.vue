<template>
  <section id="footer">
    <div class="container">
      <div class="row text-center text-xs-center text-sm-left text-md-left" v-if="showLinks">
        ...
        <div class="col-xs-12 col-sm-4 col-md-4">
          <ul class="list-unstyled quick-links">
            <li>
              <router-link to="/">
                <i class="fa fa-angle-double-right"></i>Youtube
              </router-link>
            </li>
            <li>
              <router-link to="/">
                <i class="fa fa-angle-double-right"></i>Twitch
              </router-link>
            </li>
            <li>
              <router-link to="/">
                <i class="fa fa-angle-double-right"></i>Discord
              </router-link>
            </li>
          </ul>
        </div>
        <div class="col-xs-12 col-sm-4 col-md-4">
          <ul class="list-unstyled quick-links">
            ...
            <li>
              <router-link to="/">
                <i class="fa fa-angle-double-right"></i>Wiki
              </router-link>
            </li>
          </ul>
        </div>
      ...
      <div class="row">
        <div class="col-xs-12 col-sm-12 col-md-12 mt-2 mt-sm-2 text-center text">
          <p>© 2019 老王的个人博客</p>
          <p class="h6">
            Copyright © 2019
            <a class="text-green ml-2">laowangomg.com</a>
          </p>
        </div>
      </div>
    </div>
